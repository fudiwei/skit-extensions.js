interface Date {
     ...
     * @param {Number} milliseconds 毫秒数。如果传入的是小数，将四舍五入到最接近的整数。
     * @returns {Date}
     */
     ...
     * @param {Number} seconds 秒数。如果传入的是小数，将四舍五入到最接近的整数。
     * @returns {Date}
     */
     ...
     * @param {Number} minutes 分钟数。如果传入的是小数，将四舍五入到最接近的整数。
     * @returns {Date}
     */
     ...
     * @param {Number} hours 小时数。如果传入的是小数，将四舍五入到最接近的整数。
     * @returns {Date}
     */
     ...
     * @param {Number} days 天数。如果传入的是小数，将四舍五入到最接近的整数。
     * @returns {Date}
     */
